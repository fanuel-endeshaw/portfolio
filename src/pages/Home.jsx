    ...
    >
      ...
      <Box flex={1} sx={{ textAlign: { xs: "center", md: "left" } }}>
        ...
        <Box sx={{ justifyContent: "center", maxWidth: "600px" }}>
          ...
          >
            I am a React Native Specialist and Fullstack Developer dedicated to
            building slick, production-ready applications from the ground up. By
            combining a passion for fluid mobile interfaces with a robust
            backend foundation in Spring Boot and Node.js, I bridge the gap
            between complex business logic and seamless user experiences.
          </Typography>
        </Box>
