...
const About = () => {
  return (
    <Box
      id="about"
      sx={{
        bgcolor: "#000", // Matches your dark theme
        py: { xs: 8, md: 12 },
        color: "white",
      }}
    >
        ...
        >
          ...
          <Box sx={{ flex: 1 }}>
            ...
            >
              ...
              technology to solve real-world problems, I’m excited to introduce
              myself. With strong analytical and problem-solving skills, I bring
              a solid foundation in software Engineering principles and modern
              programming languages like React Native, Spring Boot, and Node.js.
            </Typography>
